...
<h3 align="center">I specialize in web development. On the frontend, I wield the power of HTML, CSS, Tailwind and JavaScript, with proficiency in frameworks like React. On the backend, I leverage Node.js, Express.js to build scalable and efficient server-side logic. Databases like MongoDB is my playground for crafting reliable data architectures.</h3>
